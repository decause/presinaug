...
<html>
    <head>
        ...
        <script type="text/javascript" src="./static/js/lib/pixi.dev.js"></script>

        <!-- matter lib v0.8.0 -->
        <script type="text/javascript" src="./static/js/lib/matter-0.8.0.js"></script>

        <!-- only required if using MatterTools -->
        <link rel="stylesheet" href="./static/js/lib/matter-tools/matter-tools.css" type="text/css">
        <script type="text/javascript" src="http://code.jquery.com/jquery-1.11.0.min.js"></script>
        <script type="text/javascript" src="./static/js/lib/matter-tools/matter-tools-dev.js"></script>
